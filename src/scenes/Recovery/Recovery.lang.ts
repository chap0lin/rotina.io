...
texts.set("pt-br", {
  ...
  newPasswordHint:
    "inclua no mínimo 8 caracteres, sendo pelo menos um deles especial.",
  passwordsDontMatch: "as senhas não coincidem.",
  passwordMustBeNew: "não pode ser igual à anterior.",
  passwordChangeWasSuccessful:
    "A senha da sua conta foi alterada com sucesso. Experimente fazer o login agora!",
  somethingWentWrong:
...
texts.set("en-us", {
  ...
  newPasswordHint:
    "password must be at least 8 characters long, with at least one special.",
  passwordsDontMatch: `the passwords don't match.`,
  passwordMustBeNew: "can't be equal to the last.",
  passwordChangeWasSuccessful:
    "Your account password has been successfuly changed! Try signing in now!",
