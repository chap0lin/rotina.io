...
export default function ActivitySettings({
  ...
  const [newActivity, setNewActivity] = useState<activityType | null>(
    () => detailsTexts.exampleActivity
  );
  const [timeCheckMessage, setTimeCheckMessage] = useState<string | null>(
    () => null
  );
        ...
        <Inputs>
          ...
          <HourInputs>
            <HourInput
              ...
              onChange={(e) =>
                updateActivity({ startsAt: parseTime(e.target.value) })
              }
            />
            ...
            <HourInput
              ...
              onChange={(e) =>
                updateActivity({ endsAt: parseTime(e.target.value) })
              }
            />
          </HourInputs>
        </Inputs>
